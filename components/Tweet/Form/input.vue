<template>
    <div>
        <div class="flex items-center flx-shrink-0 p-4 pb-0">
        ...
        <div class="p-4 pl-16 ">
            ...
            <input @change="handleImageChange" type="file" class="hidden" ref="imageInput"
        ...
        <div class="flex p-2 pl-14">
            <div class="flex w-full text-white">
                 <div @click="handleImageClick"
                    class="p-2 text-blue-400 cursor-pointer rounded-full hover:bg-blue-50 dark:hover:bg-dim-800">
                ...
                <div class="p-2 text-blue-400 cursor-pointer rounded-full hover:bg-blue-50 dark:hover:bg-dim-800">
                    <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
                        <g>
                            <path
